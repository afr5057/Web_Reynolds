...
For this we'll be creating a visualization dashboard website using visualizations created previously. Specifically, we'll be plotting [weather data](Resources/cities.csv).
...
* Is responsive (using media queries). The nav must have background color change.
